...
export default function CTASection() {
  return (
    <section id="contact" className="px-4 sm:px-6 lg:px-[8%] py-16 md:py-[100px]">
      <div className="relative bg-gradient-to-br from-[#1a0500] via-[#2d0e00] to-[#1a0500] border border-[#C84B1140] rounded-2xl md:rounded-3xl px-6 sm:px-10 md:px-16 py-14 md:py-10 text-center overflow-hidden">
        {/* Glow */}
        ...
        <div className="relative z-10">
          ...
          <p className="text-[#A0806A] text-sm sm:text-base leading-relaxed mb-8 mt-8 md:mb-10">
            متاحين ٧ أيام في الأسبوع من  ٧ الصبح لـ ١٢ بالليل
            <br className="hidden sm:block" />
            التوصيل متاح طول اليوم على أبوابك
          </p>
